      ...
      <div className="flex-1 max-w-md">
        <div className="relative">
          ...
          <Input
            ...
            className="pl-10 bg-gray-50/80 border-gray-200 focus-visible:ring-2 focus-visible:ring-blue-500/20 transition-all rounded-full h-10"
          />
        </div>
      </div>

      {/* Seção de ações - centralizada verticalmente */}
      <div className="flex items-center gap-4">
        {/* Notificações */}
        <Button 
          variant="ghost" 
          size="sm" 
          className="relative hover:bg-gray-100 transition-colors h-10 w-10 p-0 rounded-full"
        >
