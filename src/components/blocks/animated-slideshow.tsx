...
import { clipPathVariants } from "./animated-slideshow-constants"
    ...
    >
      {characters.map((char, index) => (
        ...
        >
          ...
          >            <motion.span
              className="inline-block opacity-20 bg-gradient-to-r from-[#E9342E] to-[#FF9334] bg-clip-text text-transparent"
              initial={{ y: "0%" }}
            ...
            <motion.span
              className="absolute left-0 top-0 inline-block opacity-100 bg-gradient-to-r from-[#E9342E] to-[#FF9334] bg-clip-text text-transparent"
              initial={{ y: "110%" }}
